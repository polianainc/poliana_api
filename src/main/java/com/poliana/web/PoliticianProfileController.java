 ...
 */
@Controller
public class PoliticianProfileController extends AbstractBaseController {

    private PoliticianProfileService profileService;

    private static final Logger logger = Logger.getLogger(PoliticianProfileController.class);
