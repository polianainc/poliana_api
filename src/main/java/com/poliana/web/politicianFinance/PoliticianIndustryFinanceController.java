...
public class PoliticianIndustryFinanceController extends AbstractBaseController {
    ...
    public @ResponseBody List<PoliticianIndustryContributionTotals> getIndustryToPoliticianTotals(
            @PathVariable("bioguide_id") String bioguideId) {

        List<PoliticianIndustryContributionTotals> allTotals = politicianIndustryFinanceService.getIndustryToPoliticianTotals(bioguideId);
        return allTotals;
    }
    ...
    public @ResponseBody List<PoliticianIndustryContributionTotals> getIndustryCategoryToPoliticianTotals(
            @PathVariable("bioguide_id") String bioguideId) {

        List<PoliticianIndustryContributionTotals> allTotals =
    ...
    public @ResponseBody List<PoliticianIndustryContributionTotals> getIndustryToPoliticianTotals(
        ...
        List<PoliticianIndustryContributionTotals> allTotals = politicianIndustryFinanceService.getIndustryToPoliticianTotals(bioguideId, congress);
        return allTotals;
    }
    ...
    public void plotIndustryCategoryToPoliticianTotals (
        ...
        List<PoliticianIndustryContributionTotals> allTotals = politicianIndustryFinanceService.getIndustryCategoryToPoliticianTotals(bioguideId, congress);
