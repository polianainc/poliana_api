    CREATE EXTERNAL TABLE IF NOT EXISTS legislators_120113 (
        id STRING,
        class_name STRING,
        first_name STRING,
        last_name STRING,
    ...
    TBLPROPERTIES('mongo.uri'='mongodb://spring:N0amCh0msky1!@ds035428.mongolab.com:35428/processing_cache');
