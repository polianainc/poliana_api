...
public class SessionTotals {
    ...
    private List<PoliticianIndustryContributionTotals> topIndustryContributions;
    ...
    public List<PoliticianIndustryContributionTotals> getTopIndustryContributions() {
        return topIndustryContributions;
    }

    public void setTopIndustryContributions(List<PoliticianIndustryContributionTotals> topIndustryContributions) {
