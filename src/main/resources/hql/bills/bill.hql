CREATE EXTERNAL TABLE bills.bills_json_external (
...
LOAD DATA INPATH 's3n://polianaprod/legislation/bills_json/'
OVERWRITE INTO TABLE bills.bills_json;

CREATE EXTERNAL TABLE bills.bills_json1 (
   actions ARRAY<STRUCT<
       acted_at: STRING,
       committee: STRING,
       how: STRING,
...
ROW FORMAT SERDE 'com.proofpoint.hive.serde.JsonSerde'
 WITH SERDEPROPERTIES ('errors.ignore' = 'true')
 LOCATION 's3n://polianaprod/legislation/bills_flat/';