...
import com.poliana.bills.entities.govtrack.bills.Action;
import com.poliana.bills.entities.govtrack.bills.Sponsor;
...
public class AmendmentGt {
    ...
    @Property("amends_bill")
    private BillRef amendsBill;
    @Property("amends_treaty")
