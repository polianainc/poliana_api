...
public class PoliticianPacMongoRepo {
    ...
    public Iterable<Key<PoliticianPacContributionsTotals>> savePacToPoliticianContributions(List<PoliticianPacContributionsTotals> contributionsListMock) {
    ...
    public Iterator<PoliticianPacContributionsTotals> getPacToPoliticianContributionsIterator(String bioguideId, int... cycles) {
