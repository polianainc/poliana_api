...
public class IndustryContributionController extends AbstractBaseController {
     ...
     * @return
     */
    @RequestMapping(value = "/{industry_id}/contributions", method = RequestMethod.GET, produces = "application/json", headers = "x-requested-with=XMLHttpRequest")
     ...
     * @return
     */
    @RequestMapping(value = "/category/{category_id}/contributions", method = RequestMethod.GET, produces = "application/json", headers = "x-requested-with=XMLHttpRequest")
     ...
     * @return
     */
    @RequestMapping(value = "/{industry_id}/contributions", params = {"plot"}, method = RequestMethod.GET, produces = "application/json", headers = "x-requested-with=XMLHttpRequest")
    public @ResponseBody
     ...
     * @return
     */
    @RequestMapping(value = "/categories/{category_id}/contributions", params = {"plot"}, method = RequestMethod.GET, produces = "application/json", headers = "x-requested-with=XMLHttpRequest")
    public @ResponseBody
     ...
     * @return
     */
    @RequestMapping(value = "/{industry_id}/contributions", params = {"compare_to"}, method = RequestMethod.GET, produces = "application/json", headers = "x-requested-with=XMLHttpRequest")
    public @ResponseBody
     ...
     * @return
     */
    @RequestMapping(value = "/categories/{category_id}/contributions", params = {"compare_to"}, method = RequestMethod.GET, produces = "application/json", headers = "x-requested-with=XMLHttpRequest")
    public @ResponseBody
     ...
     * @return
     */
    @RequestMapping(value = "/{industry_id}/contributions", params = {"compare_to", "plot"}, method = RequestMethod.GET, produces = "application/json", headers = "x-requested-with=XMLHttpRequest")
     ...
     * @return
     */
    @RequestMapping(value = "/categories/{category_id}/contributions", params = {"compare_to", "plot"}, method = RequestMethod.GET, produces = "application/json", headers = "x-requested-with=XMLHttpRequest")
