CREATE EXTERNAL TABLE entities_external.legislators_json (
    bio STRUCT<
        gender: STRING,
        birthday: STRING,
        religion: STRING
...
CREATE EXTERNAL TABLE entities_external.legislators_flat_terms (
    first_name STRING,
    last_name STRING,
    official_full STRING,
    party STRING,
...
CREATE EXTERNAL TABLE entities_external.legislators_flat (
    first_name STRING,
    last_name STRING,
    official_full STRING,
    party STRING,
