...
LOCATION 's3n://polianatest/sample/contributions/crp/committees/';
...
LOCATION 's3n://polianatest/sample/contributions/crp/individuals/';
...
LOCATION 's3n://polianatest/sample/contributions/crp/pac_other/';
...
ROW FORMAT SERDE 'com.bizo.hive.serde.csv.CSVSerde'
LOCATION 's3n://polianatest/sample/contributions/sunlight/';
...
LOCATION 's3n://polianatest/sample/expenditures/';
...
row format serde 'com.bizo.hive.serde.csv.CSVSerde'
LOCATION 's3n://polianatest/sample/personmeta/pols_csv/';
...
row format serde 'com.bizo.hive.serde.csv.CSVSerde'
LOCATION 's3n://polianatest/sample/metadata/industry_codes/';
...
row format serde 'com.bizo.hive.serde.csv.CSVSerde'
LOCATION 's3n://polianatest/sample/metadata/cong_cmte_codes/'; 
...
row format serde 'com.bizo.hive.serde.csv.CSVSerde'
LOCATION 's3n://polianatest/sample/metadata/candidate_ids/'; 